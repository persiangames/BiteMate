export declare const MEETUP_STATUSES: readonly ["OPEN", "SCHEDULED", "FULL", "COMPLETED", "CANCELLED", "EXPIRED"];
export type MeetupStatus = (typeof MEETUP_STATUSES)[number];
export declare const MEETUP_INVITE_STATUSES: readonly ["PENDING", "ACCEPTED", "REJECTED", "EXPIRED"];
export type MeetupInviteStatus = (typeof MEETUP_INVITE_STATUSES)[number];
export declare const MEETUP_ROOM_STATUSES: readonly ["ACTIVE", "CLOSED"];
export type MeetupRoomStatus = (typeof MEETUP_ROOM_STATUSES)[number];
export declare const MEETUP_MATCH_TYPES: readonly ["USER", "MEETUP"];
...
//# sourceMappingURL=meetup.dto.d.ts.map