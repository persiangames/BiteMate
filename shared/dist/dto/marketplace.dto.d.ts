...
export declare const BOOKING_TYPES: readonly ["RESTAURANT_TABLE", "HOME_CHEF_MEAL"];
export type BookingType = (typeof BOOKING_TYPES)[number];
export declare const BOOKING_STATUSES: readonly ["PENDING", "CONFIRMED", "CANCELLED", "COMPLETED"];
export type BookingStatus = (typeof BOOKING_STATUSES)[number];
export declare const REVIEW_TARGET_TYPES: readonly ["RESTAURANT", "HOME_CHEF"];
