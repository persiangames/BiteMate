export declare const FOOD_INTENT_STATUSES: readonly ["ACTIVE", "MATCHED", "CANCELLED", "EXPIRED", "COMPLETED"];
export type FoodIntentStatus = (typeof FOOD_INTENT_STATUSES)[number];
export declare const INTENT_MATCH_TYPES: readonly ["INTENT", "USER"];
...
//# sourceMappingURL=intent.dto.d.ts.map