...
export declare const RESTAURANT_APPROVAL_STATUSES: readonly ["PENDING", "APPROVED", "REJECTED"];
export type RestaurantApprovalStatus = (typeof RESTAURANT_APPROVAL_STATUSES)[number];
export declare const ABUSE_REPORT_STATUSES: readonly ["OPEN", "REVIEWING", "RESOLVED", "DISMISSED"];
export type AbuseReportStatus = (typeof ABUSE_REPORT_STATUSES)[number];
export declare const ABUSE_REPORT_TARGET_TYPES: readonly ["USER", "RESTAURANT", "POST", "MEETUP"];
export type AbuseReportTargetType = (typeof ABUSE_REPORT_TARGET_TYPES)[number];
export type AdminPermission = 'users' | 'restaurants' | 'finance' | 'reports' | 'analytics';
export declare const ADMIN_ROLE_PERMISSIONS: Record<'PLATFORM_ADMIN' | 'MODERATOR', AdminPermission[]>;
